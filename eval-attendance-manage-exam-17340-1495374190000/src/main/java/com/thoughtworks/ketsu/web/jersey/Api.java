    ...
    public Api(ServiceLocator locator) throws Exception {
        ...
        register(new AbstractBinder() {
            ...
            protected void configure() {
                ...
                bind(com.thoughtworks.ketsu.infrastructure.repositories.EmployeeRepositoryImpl.class).to(EmployeeRepository.class);
                bind(com.thoughtworks.ketsu.infrastructure.repositories.AttendanceRepositoryImpl.class).to(AttendanceRepository.class);
