...
import com.thoughtworks.ketsu.infrastructure.repositories.AttendanceRepositoryImpl;
import com.thoughtworks.ketsu.infrastructure.repositories.EmployeeRepositoryImpl;
...
public class Models extends AbstractModule {
    ...
    protected void configure() {
        ...
        bind(AttendanceRepository.class).to(AttendanceRepositoryImpl.class);
    }
