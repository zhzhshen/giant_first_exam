...
public class Api extends ResourceConfig {
    ...
    public Api(ServiceLocator locator) throws Exception {
        ...
        String dbname = System.getenv().getOrDefault("DB_DATABASE", "supermarket");
        ...
        register(new AbstractBinder() {
            ...
            protected void configure() {
                ...
                bind(com.thoughtworks.ketsu.infrastructure.repositories.ContainerRepositoryImpl.class).to(ContainerRepository.class);
                bind(com.thoughtworks.ketsu.infrastructure.repositories.WarehouseRepositoryImpl.class).to(WarehouseRepository.class);
